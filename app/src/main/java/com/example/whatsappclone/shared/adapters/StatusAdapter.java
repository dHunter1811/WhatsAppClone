...
import com.example.whatsappclone.shared.models.Status; // Ganti dengan package Anda
import java.util.List;
import de.hdodenhof.circleimageview.CircleImageView;
// Gunakan library Glide atau Picasso untuk memuat gambar dari URL
// implementation 'com.github.bumptech.glide:glide:4.12.0'
import com.bumptech.glide.Glide;
import com.example.whatsappclone.status.StatusViewerActivity;
...
public class StatusAdapter extends RecyclerView.Adapter<StatusAdapter.StatusViewHolder> {
    ...
    public StatusViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_status_list, parent, false);
